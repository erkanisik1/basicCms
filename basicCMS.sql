...
--
-- Anamakine: localhost
-- Üretim Zamanı: 21 Tem 2020, 13:12:44
...
CREATE TABLE `lang` (
  ...
  `flagsLink` varchar(100) NOT NULL,
...
INSERT INTO `lang` (`id`, `lang`, `flagsLink`, `shortcut`) VALUES
(1, 'Turkish', '/', 'tr'),
(2, 'English', '/', 'en');
...
CREATE TABLE `menu` (
  ...
  `lang` varchar(50) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
INSERT INTO `menu` (`id`, `name`, `nameSeo`, `link`, `catID`, `lang`) VALUES
(4, 'Anasayfa', 'anasayfa', '/', 4, 'tr'),
(5, 'Hakkımızda', 'hakkimizda', '/about', 4, 'tr'),
(6, 'İletişim', 'iletisim', '/contact', 4, 'tr'),
(7, 'Mainpage', 'mainpage', '/', 4, 'en'),
(8, 'About', 'about', '/about', 4, 'en'),
(9, 'Contact', 'contact', '/contact', 4, 'en');
...
--
-- Tablo döküm verisi `menucat`
--

INSERT INTO `menucat` (`id`, `name`, `nameSeo`) VALUES
(3, 'test', 'test'),
(4, 'Top Menu', 'top-menu');
...
CREATE TABLE `permissions` (
  ...
  `data` varchar(100) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `user` (
  ...
  `verification` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `user` (`id`, `name`, `password`, `authority`, `status`, `avatar`, `createDate`, `mail`, `verification`, `banned`, `activation`) VALUES
(45, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, '', '2020-07-13 20:37:42', 'admin@admin.com', '', 0, 0);
